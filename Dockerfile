FROM docker.repo.local.sfdc.net/sfci/kuleana/rust-builder/kuleana-rust-builder:51 AS builder
...
FROM docker.repo.local.sfdc.net/sfci/docker-images/sfdc_centos7:167
