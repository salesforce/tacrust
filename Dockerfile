FROM docker.repo.local.sfdc.net/sfci/kuleana/rust-builder/kuleana-rust-builder:50 AS builder
...
FROM docker.repo.local.sfdc.net/sfci/docker-images/sfdc_centos7:160
